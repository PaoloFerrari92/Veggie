        ...
        <div className="pb-16">
            <div className="bg-gray-100 flex flex-col justify-center items-center pt-9 sm:pt-12 lg:pt-16 pb-24 sm:pb-52">
                <div className="2xl:container 2xl:mx-auto flex flex-col justify-center items-center sm:pb-12 lg:pb-0 space-y-4 px-4 md:px-6 2xl:px-0">
                    <div>
                        <p className="text-3xl lg:text-4xl font-semibold leading-9 text-center text-gray-800">The Vegetarian</p>
                    </div>
                    <div>
                        <p className="text-base leading-normal sm:leading-none text-center text-gray-600 pb-8">Explore the recommended vegetarian recipes for you</p>
                    </div>
                    <div>
                        <Splide>
                        {veggie.map((recipe) => {
                            return(
                                ...
                                <div key ={recipe.id}>
                                    <div className="relative flex flex-col justify-center items-center">
                                        ...
                                        <img src={recipe.image} alt={recipe.title} className="recipeTile__img  items-center"/>
