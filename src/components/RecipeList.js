            ...
            <div className="bg-gray-100 flex flex-col justify-center items-center pt-9 sm:pt-12 lg:pt-16 pb-24 sm:pb-52">
                <div className="2xl:container 2xl:mx-auto flex flex-col justify-center items-center sm:pb-12 lg:pb-0 space-y-4 px-4 md:px-6 2xl:px-0">
                    <div className="grid grid-cols-2 grid-rows-3 flex space-x-4">
                        ...
                        { cuisine.map( ( item ) => {
                            return (
                                <div key={ item.id } className="grid-cols-2 grid-template-columns: repeat(2, minmax(0, 1fr));">
                                    ...
                                    { !done ? (
                                        ...
                                        <Link to={ "/recipe/" + item.id }>
                                            <img className="object-center object-cover" src={ item.image } alt={ item.title } />
                                            <h5 className="bg-gray-100 text-center justify-center items-center pt-9 sm:pt-12 lg:pt-16 pb-12 sm:pb-12 font-semibold overflow: hidden; truncate text-ellipsis overflow-hidden ... space-x-0.5 ">{ item.title }</h5>
                                        </Link>
                                    ) }
